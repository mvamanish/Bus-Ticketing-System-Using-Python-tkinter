    ...
    def travel_Cost(self):
       ...
       #-------------------------------------Total Ticket Cost----------------------------------------------------------
        ...
        if (self.boarding_Combo.get() == "Esplanade") and (self.des_Combo.get() == "Belghoria"):
            ...
            t_fare = fare + 22
        elif (self.boarding_Combo.get() == "Sealdah Fly Over") and (self.des_Combo.get() == "Belghoria"):
            t_fare = fare + 20
        elif (self.boarding_Combo.get() == "Maniktala") and (self.des_Combo.get() == "Belghoria"):
            t_fare = fare + 17
        elif (self.boarding_Combo.get() == "Shyambazar") and (self.des_Combo.get() == "Belghoria"):
            t_fare = fare + 15
        elif (self.boarding_Combo.get() == "Nagerbazar") and (self.des_Combo.get() == "Belghoria"):
            t_fare = fare + 11
        elif (self.boarding_Combo.get() == "Birati") and (self.des_Combo.get() == "Belghoria"):
            t_fare = fare + 9
        elif (self.boarding_Combo.get() == "Esplanade") and (self.des_Combo.get() == "Birati"):
            t_fare = fare + 22
        elif (self.boarding_Combo.get() == "BB Ganguly Street") and (self.des_Combo.get() == "Birati"):
            t_fare = fare + 20
        elif (self.boarding_Combo.get() == "Sealdah Fly Over") and (self.des_Combo.get() == "Birati"):
            t_fare = fare + 17
        elif (self.boarding_Combo.get() == "Maniktala") and (self.des_Combo.get() == "Birati"):
            t_fare = fare + 15
        elif (self.boarding_Combo.get() == "Shyambazar") and (self.des_Combo.get() == "Birati"):
            t_fare = fare + 11
        elif (self.boarding_Combo.get() == "Nagerbazar") and (self.des_Combo.get() == "Birati"):
            t_fare = fare + 9
        elif (self.boarding_Combo.get() == "Esplanade") and (self.des_Combo.get() == "Nagerbazar"):
            t_fare = fare + 20
        elif (self.boarding_Combo.get() == "BB Ganguly Street") and (self.des_Combo.get() == "Nagerbazar"):
            t_fare = fare + 17
        elif (self.boarding_Combo.get() == "Sealdah Fly Over") and (self.des_Combo.get() == "Nagerbazar"):
            t_fare = fare + 15
        elif (self.boarding_Combo.get() == "Maniktala") and (self.des_Combo.get() == "Nagerbazar"):
            t_fare = fare + 11
        elif (self.boarding_Combo.get() == "Shyambazar") and (self.des_Combo.get() == "Nagerbazar"):
            t_fare = fare + 9
        elif (self.boarding_Combo.get() == "Esplanade") and (self.des_Combo.get() == "Shyambazar"):
            t_fare = fare + 17
        elif (self.boarding_Combo.get() == "BB Ganguly Street") and (self.des_Combo.get() == "Shyambazar"):
            t_fare = fare + 15
        elif (self.boarding_Combo.get() == "Sealdah Fly Over") and (self.des_Combo.get() == "Shyambazar"):
            t_fare = fare + 11
        elif (self.boarding_Combo.get() == "Maniktala") and (self.des_Combo.get() == "Shyambazar"):
            t_fare = fare + 9
        elif (self.boarding_Combo.get() == "Esplanade") and (self.des_Combo.get() == "Maniktala"):
            t_fare = fare + 15
        elif (self.boarding_Combo.get() == "BB Ganguly Street") and (self.des_Combo.get() == "Maniktala"):
            t_fare = fare + 11
        elif (self.boarding_Combo.get() == "Sealdah Fly Over") and (self.des_Combo.get() == "Maniktala"):
            t_fare = fare + 9
        elif (self.boarding_Combo.get() == "Esplanade") and (self.des_Combo.get() == "Sealdah Fly Over"):
            t_fare = fare + 11
        elif (self.boarding_Combo.get() == "BB Ganguly Street") and (self.des_Combo.get() == "Sealdah Fly Over"):
            t_fare = fare + 9
        elif (self.boarding_Combo.get() == "Esplanade") and (self.des_Combo.get() == "BB Ganguly Street"):
            t_fare = fare + 9
